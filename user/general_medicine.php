...
$_SESSION['department'] = 'general medicine';
...
<body>
  ...
  <div class="topic">
    <h1> <img src="../images/endocrine.png" height="50px">GENERAL MEDICINE</h1>
  </div>
          ...
          <div class="btn-one">
            ...
            <div class="info-box">
              ...
              <form name="gm" method="POST">
                <input value="<?php echo $row["doctor_id"] ?>" name="doctor_id" type="hidden">
